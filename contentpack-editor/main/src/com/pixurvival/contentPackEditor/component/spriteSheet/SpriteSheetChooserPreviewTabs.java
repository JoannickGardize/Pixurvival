...
public class SpriteSheetChooserPreviewTabs extends JPanel {
	...
	private @Getter ElementChooserButton<SpriteSheet> spriteSheetChooser = new ElementChooserButton<SpriteSheet>(SpriteSheet.class, LayoutUtils.getSpriteSheetIconProvider());
