...
public interface AnnotationHandler {
     ...
     *
     * @param node       the node to check, it's root value is an instance of
     *                   {@link ContentPack}
     * @param annotation the annotation for which this handler is called, this is always an
     *                   instance of annotation for which it's type is returned by
     *                   {@link #getHandledAnnotations()}
     * @param errors     the error collection to add validation errors in
     */
     ...
     * initialization.
     *
     * @param imageAccessor the ImageAccessor to use for this validation
     */
     ...
     *
     * @param errors the error collection to add validation errors inS
     */
