...
public class MapAnalytics {
     ...
     * @param criteria the wanted criteria
     ...
     * simple path.
     *
     * @param cursor    cursor for accessing tile data
     * @param position1
     * @param position2
     * @param maxFail   Maximum number of "fail" of the algorithm, a "fail" happens each
