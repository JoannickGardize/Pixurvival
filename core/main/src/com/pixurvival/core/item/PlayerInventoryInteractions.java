...
public class PlayerInventoryInteractions {
     ...
     * </ul>
     *
     * @param playerInventory      the player inventory. Only
     *                             {@link PlayerInventory#getHeldItemStack()} may change
     * @param interactionInventory the interaction inventory, only the slot at {@code slotIndex} may
     *                             change
     * @param slotIndex            the slot index of the {@code interactionInventory} the player is
     *                             interacting with. If the index is invalid, nothing happens
     * @param splitMode            if false, normal interaction is done, if true, a split interaction
     *                             is done
     */
