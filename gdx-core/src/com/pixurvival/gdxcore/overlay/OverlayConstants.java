...
public class OverlayConstants {
    ...
    public static final float ENTITY_OVERLAY_MARGIN = 7f;

    public static final float LIFE_BAR_WIDTH = 40f;

    public static final float LIFE_BAR_HEIGHT = 10f;

    public static final float WORKING_BAR_WIDTH = 55f;

    public static final float WORKING_BAR_HEIGH = 13f;

    public static final Color ENNEMY_LIFE_BAR_COLOR = Color.RED;

    public static final Color ALLY_LIFE_BAR_COLOR = Color.GREEN;

    public static final Color WORKING_BAR_COLOR = Color.WHITE;

    public static final Color DURATION_BAR_COLOR = Color.ORANGE;
}
